...
window.addEventListener('load', () => {
  ...
  // note the use of half float texture and the
  // custom sampler name used in our fragment shader
  const flowMapParams = {
    sampler: 'uFlowMap',
  ...
  const displacementFs = `
        ...
        void main() {
            ...
            vec3 tex1 = texture2D(planeTexture1, vPlaneTextureCoord).rgb;
            vec3 tex2 = texture2D(planeTexture2, vPlaneTextureCoord).rgb;
